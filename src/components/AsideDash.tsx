...
export default function Aside() {
  ...
  return (
    <aside className="h-screen w-[290px] flex flex-col items-center py-12 bg-[#1A1A1A] text-white">
      <Image src={Logo} alt="logo" width={75} />
      <div className="w-full flex flex-col gap-3 justify-center items-start p-5 mt-5">
        <label htmlFor="menu" className="w-fit flex justify-center items-center">
          Menu:
        </label>
        <nav className="w-full">
          <ul className="flex flex-col gap-3">
            <Links
              WebRoute="/dashboard/overview"
              text="Overview"
      ...
      <div className="w-full p-5">
        ...
        <div className="w-full p-2 flex flex-col items-center bg-[#333333] rounded-lg gap-3">
          ...
          <Link
            ...
            className="w-fit flex gap-2 mt-2 items-center hover:opacity-70 transition rounded-lg bg-[#5151F9] p-1 px-2"
          >
